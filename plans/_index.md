...
| 5 | [Content pipeline & animation](phase-5-content-pipeline-animation.md) | 🚧 | All 5 greetings phrases have a real, approved fal.ai clip (Dadi + Neighbour only). Mobile app doesn't serve them yet — that's the next step |
