...
| 13 | [Foundations: Vocabulary, Numbers, Aksharmala](phase-13-foundations-vocab-numbers-alphabet.md) | 🚧 | Three new beginner content types, modeled on `learn-bharat`'s Fundamentals but built to avoid its live-TTS/dead-image/incomplete-alphabet mistakes. Started 2026-08-03 — project owner re-sequenced ahead of phase 12's remaining steps (i18n/app-store/tutor-verification/monetization), paused rather than finished first. Schema + Convex backend built (6 new tables, `vocabulary.ts`, `aksharmala.ts`). Aksharmala live for 3 scripts: Devanagari (49/49), Bengali (53/53), Tamil (37/37, added 2026-08-04, WebSearch-verified sourcing) — all on Google Chirp3-HD. Vocabulary categories live: Numbers 1–20/50/100/1000, Family, Food & Drink, Animals, Colours, Body Parts, Household Items, Clothing, Vegetables (9 categories, all hi audio + fal.ai images, real image-generation defects caught and fixed in each — see phase file). Learn tab's 4-card Foundations root shipped and visually polished. Mobile UI for all 4 screens built by ui-guardian and live in the Simulator. Next: Telugu/Kannada/Gujarati Aksharmala (voices already provisioned), Punjabi/Malayalam (need voice check), Urdu/Manipuri (RTL/font risk, route through ui-guardian), more vocabulary categories, then resume phase 12 |
